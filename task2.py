...
# time.sleep(5)
user = "Enter your email or password"
...
browser.find_element_by_name("query").send_keys("Hyderabad")
browser.find_element_by_class_name("z.ba.bb.bc.bd").click()
browser.find_element_by_class_name("bo.bp").click()
browser.find_element_by_xpath("//*[@id=\"root\"]/table/tbody/tr/td/ul/li[3]/table/tbody/tr/td/a").click()
browser.find_element_by_class_name("cl.cj.cm").click()
